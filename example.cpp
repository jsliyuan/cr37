...
{   
  ...
  BooleanFun *f1 = new BooleanFun(6);
    ...
    anf3_14=f1->get_anf();
   fn3_14.insert(anf3_14);
   F3_14.insert(f1->get_anf());
}
fin.close();

/*for(set<string>::iterator it=F3_14.begin();it!=F3_14.end();it++)
{
    cout<<*it<<endl;
    num=num+1;
}
    ...
    if (all_in) {
      ...
      for (set<string>::iterator magic32=fn6_6.begin();magic32!=fn6_6.end();magic32++) {
        ...
        string anf7=fmm.get_anf();
          ...
          if(fn3_14.find(anf7)==fn3_14.end())
          {
         //   cout<<anf7<<endl;
            all_in_32 = false;
            break;
